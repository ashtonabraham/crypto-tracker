  ...
  return (
    <>
      ...
      <button
        ...
        className="relative flex items-center gap-2 px-4 py-2.5 bg-bg-tertiary border border-border rounded-lg text-sm font-medium transition-all hover:bg-accent-blue hover:border-accent-blue"
      >
            ...
            <div className="p-5 overflow-y-auto max-h-[calc(80vh-140px)]">
              ...
              {showForm ? (
                ...
                <button
                  ...
                  className="w-full mb-5 py-3 border-2 border-dashed border-border rounded-xl text-sm text-gray-400 hover:text-white hover:border-gray-600 transition-all flex items-center justify-center gap-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
