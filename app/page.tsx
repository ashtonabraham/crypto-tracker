        ...
        <header className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              disabled={isLoading}
              className="flex items-center gap-2 px-4 py-2.5 bg-bg-tertiary border border-border rounded-lg text-sm font-medium transition-all duration-400 hover:bg-accent-blue hover:border-accent-blue disabled:opacity-50 disabled:cursor-not-allowed"
            >
              ...
              {COINS.map((coin) => {
                ...
                return (
                  <button
                    ...
                    className="bg-bg-secondary border border-border rounded-xl p-5 text-left transition-all duration-400 hover:border-accent-blue hover:bg-bg-tertiary group"
                  >
                    {/* Coin Header */}
